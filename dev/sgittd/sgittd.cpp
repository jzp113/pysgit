...
SgitTd::SgitTd(const std::string &szFlowPath) {
    this->api = CThostFtdcTraderApi::CreateFtdcTraderApi(szFlowPath.c_str());
    boost::function0<void> f = boost::bind(&SgitTd::processTask, this);
...
void SgitTd::OnFrontConnected() {
    Task *task = new Task();
    task->name = ON_FRONT_CONNECTED;
    this->task_queue.push(task);
}

void SgitTd::OnFrontDisconnected(int nReason) {
    Task *task = new Task();
...
void SgitTd::OnHeartBeatWarning(int nTimeLapse) {
    Task *task = new Task();
...
void SgitTd::OnRspAuthenticate(CThostFtdcRspAuthenticateField *pRspAuthenticateField, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspUserLogin(CThostFtdcRspUserLoginField *pRspUserLogin, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspUserLogout(CThostFtdcUserLogoutField *pUserLogout, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspUserPasswordUpdate(CThostFtdcUserPasswordUpdateField *pUserPasswordUpdate, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspTradingAccountPasswordUpdate(CThostFtdcTradingAccountPasswordUpdateField *pTradingAccountPasswordUpdate, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspOrderInsert(CThostFtdcInputOrderField *pInputOrder, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspParkedOrderInsert(CThostFtdcParkedOrderField *pParkedOrder, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspParkedOrderAction(CThostFtdcParkedOrderActionField *pParkedOrderAction, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspOrderAction(CThostFtdcInputOrderActionField *pInputOrderAction, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQueryMaxOrderVolume(CThostFtdcQueryMaxOrderVolumeField *pQueryMaxOrderVolume, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspSettlementInfoConfirm(CThostFtdcSettlementInfoConfirmField *pSettlementInfoConfirm, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspRemoveParkedOrder(CThostFtdcRemoveParkedOrderField *pRemoveParkedOrder, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspRemoveParkedOrderAction(CThostFtdcRemoveParkedOrderActionField *pRemoveParkedOrderAction, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspExecOrderInsert(CThostFtdcInputExecOrderField *pInputExecOrder, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspExecOrderAction(CThostFtdcInputExecOrderActionField *pInputExecOrderAction, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspForQuoteInsert(CThostFtdcInputForQuoteField *pInputForQuote, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQuoteInsert(CThostFtdcInputQuoteField *pInputQuote, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQuoteAction(CThostFtdcInputQuoteActionField *pInputQuoteAction, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspBatchOrderAction(CThostFtdcInputBatchOrderActionField *pInputBatchOrderAction, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspCombActionInsert(CThostFtdcInputCombActionField *pInputCombAction, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryOrder(CThostFtdcOrderField *pOrder, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryTrade(CThostFtdcTradeField *pTrade, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryInvestorPosition(CThostFtdcInvestorPositionField *pInvestorPosition, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryTradingAccount(CThostFtdcTradingAccountField *pTradingAccount, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryInvestor(CThostFtdcInvestorField *pInvestor, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryTradingCode(CThostFtdcTradingCodeField *pTradingCode, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryInstrumentMarginRate(CThostFtdcInstrumentMarginRateField *pInstrumentMarginRate, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryInstrumentCommissionRate(CThostFtdcInstrumentCommissionRateField *pInstrumentCommissionRate, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryExchange(CThostFtdcExchangeField *pExchange, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryProduct(CThostFtdcProductField *pProduct, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryInstrument(CThostFtdcInstrumentField *pInstrument, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryDepthMarketData(CThostFtdcDepthMarketDataField *pDepthMarketData, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQrySettlementInfo(CThostFtdcSettlementInfoField *pSettlementInfo, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryTransferBank(CThostFtdcTransferBankField *pTransferBank, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryInvestorPositionDetail(CThostFtdcInvestorPositionDetailField *pInvestorPositionDetail, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryNotice(CThostFtdcNoticeField *pNotice, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQrySettlementInfoConfirm(CThostFtdcSettlementInfoConfirmField *pSettlementInfoConfirm, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryInvestorPositionCombineDetail(CThostFtdcInvestorPositionCombineDetailField *pInvestorPositionCombineDetail, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryCFMMCTradingAccountKey(CThostFtdcCFMMCTradingAccountKeyField *pCFMMCTradingAccountKey, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryEWarrantOffset(CThostFtdcEWarrantOffsetField *pEWarrantOffset, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryInvestorProductGroupMargin(CThostFtdcInvestorProductGroupMarginField *pInvestorProductGroupMargin, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryExchangeMarginRate(CThostFtdcExchangeMarginRateField *pExchangeMarginRate, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryExchangeMarginRateAdjust(CThostFtdcExchangeMarginRateAdjustField *pExchangeMarginRateAdjust, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryExchangeRate(CThostFtdcExchangeRateField *pExchangeRate, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQrySecAgentACIDMap(CThostFtdcSecAgentACIDMapField *pSecAgentACIDMap, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryProductExchRate(CThostFtdcProductExchRateField *pProductExchRate, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryProductGroup(CThostFtdcProductGroupField *pProductGroup, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
//void SgitTd::OnRspQryMMInstrumentCommissionRate(CThostFtdcMMInstrumentCommissionRateField *pMMInstrumentCommissionRate, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
//    Task *task = new Task();
...
//}
//
//void SgitTd::OnRspQryMMOptionInstrCommRate(CThostFtdcMMOptionInstrCommRateField *pMMOptionInstrCommRate, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
//    Task *task = new Task();
...
//}
//
//void SgitTd::OnRspQryInstrumentOrderCommRate(CThostFtdcInstrumentOrderCommRateField *pInstrumentOrderCommRate, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
//    Task *task = new Task();
...
void SgitTd::OnRspQryOptionInstrTradeCost(CThostFtdcOptionInstrTradeCostField *pOptionInstrTradeCost, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryOptionInstrCommRate(CThostFtdcOptionInstrCommRateField *pOptionInstrCommRate, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryExecOrder(CThostFtdcExecOrderField *pExecOrder, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryForQuote(CThostFtdcForQuoteField *pForQuote, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryQuote(CThostFtdcQuoteField *pQuote, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryCombInstrumentGuard(CThostFtdcCombInstrumentGuardField *pCombInstrumentGuard, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryCombAction(CThostFtdcCombActionField *pCombAction, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryTransferSerial(CThostFtdcTransferSerialField *pTransferSerial, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryAccountregister(CThostFtdcAccountregisterField *pAccountregister, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspError(CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRtnOrder(CThostFtdcOrderField *pOrder) {
    Task *task = new Task();
...
void SgitTd::OnRtnTrade(CThostFtdcTradeField *pTrade) {
    Task *task = new Task();
...
void SgitTd::OnErrRtnOrderInsert(CThostFtdcInputOrderField *pInputOrder, CThostFtdcRspInfoField *pRspInfo) {
    Task *task = new Task();
...
void SgitTd::OnErrRtnOrderAction(CThostFtdcOrderActionField *pOrderAction, CThostFtdcRspInfoField *pRspInfo) {
    Task *task = new Task();
...
void SgitTd::OnRtnInstrumentStatus(CThostFtdcInstrumentStatusField *pInstrumentStatus) {
    Task *task = new Task();
...
//void SgitTd::OnRtnBulletin(CThostFtdcBulletinField *pBulletin) {
//    Task *task = new Task();
...
void SgitTd::OnRtnTradingNotice(CThostFtdcTradingNoticeInfoField *pTradingNoticeInfo) {
    Task *task = new Task();
...
void SgitTd::OnRtnErrorConditionalOrder(CThostFtdcErrorConditionalOrderField *pErrorConditionalOrder) {
    Task *task = new Task();
...
void SgitTd::OnRtnExecOrder(CThostFtdcExecOrderField *pExecOrder) {
    Task *task = new Task();
...
void SgitTd::OnErrRtnExecOrderInsert(CThostFtdcInputExecOrderField *pInputExecOrder, CThostFtdcRspInfoField *pRspInfo) {
    Task *task = new Task();
...
void SgitTd::OnErrRtnExecOrderAction(CThostFtdcExecOrderActionField *pExecOrderAction, CThostFtdcRspInfoField *pRspInfo) {
    Task *task = new Task();
...
void SgitTd::OnErrRtnForQuoteInsert(CThostFtdcInputForQuoteField *pInputForQuote, CThostFtdcRspInfoField *pRspInfo) {
    Task *task = new Task();
...
void SgitTd::OnRtnQuote(CThostFtdcQuoteField *pQuote) {
    Task *task = new Task();
...
void SgitTd::OnErrRtnQuoteInsert(CThostFtdcInputQuoteField *pInputQuote, CThostFtdcRspInfoField *pRspInfo) {
    Task *task = new Task();
...
void SgitTd::OnErrRtnQuoteAction(CThostFtdcQuoteActionField *pQuoteAction, CThostFtdcRspInfoField *pRspInfo) {
    Task *task = new Task();
...
void SgitTd::OnRtnForQuoteRsp(CThostFtdcForQuoteRspField *pForQuoteRsp) {
    Task *task = new Task();
...
void SgitTd::OnRtnCFMMCTradingAccountToken(CThostFtdcCFMMCTradingAccountTokenField *pCFMMCTradingAccountToken) {
    Task *task = new Task();
...
void SgitTd::OnErrRtnBatchOrderAction(CThostFtdcBatchOrderActionField *pBatchOrderAction, CThostFtdcRspInfoField *pRspInfo) {
    Task *task = new Task();
...
void SgitTd::OnRtnCombAction(CThostFtdcCombActionField *pCombAction) {
    Task *task = new Task();
...
void SgitTd::OnErrRtnCombActionInsert(CThostFtdcInputCombActionField *pInputCombAction, CThostFtdcRspInfoField *pRspInfo) {
    Task *task = new Task();
...
void SgitTd::OnRspQryContractBank(CThostFtdcContractBankField *pContractBank, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryParkedOrder(CThostFtdcParkedOrderField *pParkedOrder, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryParkedOrderAction(CThostFtdcParkedOrderActionField *pParkedOrderAction, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryTradingNotice(CThostFtdcTradingNoticeField *pTradingNotice, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryBrokerTradingParams(CThostFtdcBrokerTradingParamsField *pBrokerTradingParams, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQryBrokerTradingAlgos(CThostFtdcBrokerTradingAlgosField *pBrokerTradingAlgos, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQueryCFMMCTradingAccountToken(CThostFtdcQueryCFMMCTradingAccountTokenField *pQueryCFMMCTradingAccountToken, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRtnFromBankToFutureByBank(CThostFtdcRspTransferField *pRspTransfer) {
    Task *task = new Task();
...
void SgitTd::OnRtnFromFutureToBankByBank(CThostFtdcRspTransferField *pRspTransfer) {
    Task *task = new Task();
...
void SgitTd::OnRtnRepealFromBankToFutureByBank(CThostFtdcRspRepealField *pRspRepeal) {
    Task *task = new Task();
...
void SgitTd::OnRtnRepealFromFutureToBankByBank(CThostFtdcRspRepealField *pRspRepeal) {
    Task *task = new Task();
...
void SgitTd::OnRtnFromBankToFutureByFuture(CThostFtdcRspTransferField *pRspTransfer) {
    Task *task = new Task();
...
void SgitTd::OnRtnFromFutureToBankByFuture(CThostFtdcRspTransferField *pRspTransfer) {
    Task *task = new Task();
...
void SgitTd::OnRtnRepealFromBankToFutureByFutureManual(CThostFtdcRspRepealField *pRspRepeal) {
    Task *task = new Task();
...
void SgitTd::OnRtnRepealFromFutureToBankByFutureManual(CThostFtdcRspRepealField *pRspRepeal) {
    Task *task = new Task();
...
void SgitTd::OnRtnQueryBankBalanceByFuture(CThostFtdcNotifyQueryAccountField *pNotifyQueryAccount) {
    Task *task = new Task();
...
void SgitTd::OnErrRtnBankToFutureByFuture(CThostFtdcReqTransferField *pReqTransfer, CThostFtdcRspInfoField *pRspInfo) {
    Task *task = new Task();
...
void SgitTd::OnErrRtnFutureToBankByFuture(CThostFtdcReqTransferField *pReqTransfer, CThostFtdcRspInfoField *pRspInfo) {
    Task *task = new Task();
...
void SgitTd::OnErrRtnRepealBankToFutureByFutureManual(CThostFtdcReqRepealField *pReqRepeal, CThostFtdcRspInfoField *pRspInfo) {
    Task *task = new Task();
...
void SgitTd::OnErrRtnRepealFutureToBankByFutureManual(CThostFtdcReqRepealField *pReqRepeal, CThostFtdcRspInfoField *pRspInfo) {
    Task *task = new Task();
...
void SgitTd::OnErrRtnQueryBankBalanceByFuture(CThostFtdcReqQueryAccountField *pReqQueryAccount, CThostFtdcRspInfoField *pRspInfo) {
    Task *task = new Task();
...
void SgitTd::OnRtnRepealFromBankToFutureByFuture(CThostFtdcRspRepealField *pRspRepeal) {
    Task *task = new Task();
...
void SgitTd::OnRtnRepealFromFutureToBankByFuture(CThostFtdcRspRepealField *pRspRepeal) {
    Task *task = new Task();
...
void SgitTd::OnRspFromBankToFutureByFuture(CThostFtdcReqTransferField *pReqTransfer, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspFromFutureToBankByFuture(CThostFtdcReqTransferField *pReqTransfer, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRspQueryBankAccountMoneyByFuture(CThostFtdcReqQueryAccountField *pReqQueryAccount, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    Task *task = new Task();
...
void SgitTd::OnRtnOpenAccountByBank(CThostFtdcOpenAccountField *pOpenAccount) {
    Task *task = new Task();
...
void SgitTd::OnRtnCancelAccountByBank(CThostFtdcCancelAccountField *pCancelAccount) {
    Task *task = new Task();
...
void SgitTd::OnRtnChangeAccountByBank(CThostFtdcChangeAccountField *pChangeAccount) {
    Task *task = new Task();
...
const char *SgitTd::getApiVersion() {
...
int SgitTd::reqTradingAccountPasswordUpdate(object &tradingAccountPasswordUpdateField, int requestId) {
...
int SgitTd::reqOrderAction(object &inputOrderActionField, int requestId) {
    InputOrderActionField *p1 = extract<InputOrderActionField *>(inputOrderActionField);
    return this->api->ReqOrderAction(p1, requestId);
}

int SgitTd::reqQueryMaxOrderVolume(object &queryMaxOrderVolumeField, int requestId) {
...
int SgitTd::reqSettlementInfoConfirm(object &settlementInfoConfirmField, int requestId) {
...
int SgitTd::reqRemoveParkedOrder(object &removeParkedOrderField, int requestId) {
...
int SgitTd::reqRemoveParkedOrderAction(object &removeParkedOrderActionField, int requestId) {
...
int SgitTd::reqExecOrderInsert(object &inputExecOrderField, int requestId) {
    InputExecOrderField *p1 = extract<InputExecOrderField *>(inputExecOrderField);
    return this->api->ReqExecOrderInsert(p1, requestId);
}

int SgitTd::reqExecOrderAction(object &inputExecOrderActionField, int requestId) {
...
int SgitTd::reqCombActionInsert(object &inputCombActionField, int requestId) {
...
int SgitTd::reqQryOrder(object &qryOrderField, int requestId) {
    QryOrderField *p1 = extract<QryOrderField *>(qryOrderField);
    return this->api->ReqQryOrder(p1, requestId);
}

int SgitTd::reqQryTrade(object &qryTradeField, int requestId) {
    QryTradeField *p1 = extract<QryTradeField *>(qryTradeField);
    return this->api->ReqQryTrade(p1, requestId);
}

int SgitTd::reqQryInvestorPosition(object &qryInvestorPositionField, int requestId) {
...
int SgitTd::reqQryTradingAccount(object &qryTradingAccountField, int requestId) {
...
int SgitTd::reqQryInstrumentCommissionRate(object &qryInstrumentCommissionRateField, int requestId) {
...
int SgitTd::reqQrySettlementInfo(object &qrySettlementInfoField, int requestId) {
...
int SgitTd::reqQryTransferBank(object &qryTransferBankField, int requestId) {
    QryTransferBankField *p1 = extract<QryTransferBankField *>(qryTransferBankField);
    return this->api->ReqQryTransferBank(p1, requestId);
}

int SgitTd::reqQryInvestorPositionDetail(object &qryInvestorPositionDetailField, int requestId) {
...
int SgitTd::reqQryNotice(object &qryNoticeField, int requestId) {
    QryNoticeField *p1 = extract<QryNoticeField *>(qryNoticeField);
    return this->api->ReqQryNotice(p1, requestId);
}

int SgitTd::reqQrySettlementInfoConfirm(object &qrySettlementInfoConfirmField, int requestId) {
...
int SgitTd::reqQryInvestorPositionCombineDetail(object &qryInvestorPositionCombineDetailField, int requestId) {
...
int SgitTd::reqQryCFMMCTradingAccountKey(object &qryCFMMCTradingAccountKeyField, int requestId) {
...
int SgitTd::reqQryEWarrantOffset(object &qryEWarrantOffsetField, int requestId) {
...
int SgitTd::reqQryInvestorProductGroupMargin(object &qryInvestorProductGroupMarginField, int requestId) {
...
int SgitTd::reqQryExchangeMarginRate(object &qryExchangeMarginRateField, int requestId) {
...
int SgitTd::reqQryExchangeMarginRateAdjust(object &qryExchangeMarginRateAdjustField, int requestId) {
...
int SgitTd::reqQryExchangeRate(object &qryExchangeRateField, int requestId) {
    QryExchangeRateField *p1 = extract<QryExchangeRateField *>(qryExchangeRateField);
    return this->api->ReqQryExchangeRate(p1, requestId);
}

int SgitTd::reqQrySecAgentACIDMap(object &qrySecAgentACIDMapField, int requestId) {
...
int SgitTd::reqQryProductExchRate(object &qryProductExchRateField, int requestId) {
...
int SgitTd::reqQryProductGroup(object &qryProductGroupField, int requestId) {
    QryProductGroupField *p1 = extract<QryProductGroupField *>(qryProductGroupField);
    return this->api->ReqQryProductGroup(p1, requestId);
}

int SgitTd::reqQryOptionInstrTradeCost(object &qryOptionInstrTradeCostField, int requestId) {
...
int SgitTd::reqQryOptionInstrCommRate(object &qryOptionInstrCommRateField, int requestId) {
...
int SgitTd::reqQryCombAction(object &qryCombActionField, int requestId) {
    QryCombActionField *p1 = extract<QryCombActionField *>(qryCombActionField);
    return this->api->ReqQryCombAction(p1, requestId);
}

int SgitTd::reqQryTransferSerial(object &qryTransferSerialField, int requestId) {
...
int SgitTd::reqQryAccountregister(object &qryAccountregisterField, int requestId) {
...
int SgitTd::reqQryTradingNotice(object &qryTradingNoticeField, int requestId) {
...
int SgitTd::reqQryBrokerTradingParams(object &qryBrokerTradingParamsField, int requestId) {
...
int SgitTd::reqQryBrokerTradingAlgos(object &qryBrokerTradingAlgosField, int requestId) {
...
int SgitTd::reqQueryCFMMCTradingAccountToken(object &queryCFMMCTradingAccountTokenField, int requestId) {
...
int SgitTd::reqFromBankToFutureByFuture(object &reqTransferField, int requestId) {
    ReqTransferField *p1 = extract<ReqTransferField *>(reqTransferField);
    return this->api->ReqFromBankToFutureByFuture(p1, requestId);
}

int SgitTd::reqFromFutureToBankByFuture(object &reqTransferField, int requestId) {
    ReqTransferField *p1 = extract<ReqTransferField *>(reqTransferField);
    return this->api->ReqFromFutureToBankByFuture(p1, requestId);
}

int SgitTd::reqQueryBankAccountMoneyByFuture(object &reqQueryAccountField, int requestId) {
...
struct SgitTdWrap : SgitTd, wrapper<SgitTd> {

    SgitTdWrap(const std::string &szFlowPath = "")
            : SgitTd(szFlowPath) {}
...
BOOST_PYTHON_MODULE(sgittd) {
    if (!PyEval_ThreadsInitialized())
        PyEval_InitThreads();	//导入时运行，保证先创建GIL

    class_<SgitTdWrap, boost::noncopyable>("SgitTd", init<const std::string &>())
            .def("onFrontConnected", pure_virtual(&SgitTdWrap::onFrontConnected))
            .def("onFrontDisconnected", pure_virtual(&SgitTdWrap::onFrontDisconnected))
            .def("onHeartBeatWarning", pure_virtual(&SgitTdWrap::onHeartBeatWarning))
            .def("onRspAuthenticate", pure_virtual(&SgitTdWrap::onRspAuthenticate))
            .def("onRspUserLogin", pure_virtual(&SgitTdWrap::onRspUserLogin))
            .def("onRspUserLogout", pure_virtual(&SgitTdWrap::onRspUserLogout))
            .def("onRspUserPasswordUpdate", pure_virtual(&SgitTdWrap::onRspUserPasswordUpdate))
            .def("onRspTradingAccountPasswordUpdate", pure_virtual(&SgitTdWrap::onRspTradingAccountPasswordUpdate))
            .def("onRspOrderInsert", pure_virtual(&SgitTdWrap::onRspOrderInsert))
            .def("onRspParkedOrderInsert", pure_virtual(&SgitTdWrap::onRspParkedOrderInsert))
            .def("onRspParkedOrderAction", pure_virtual(&SgitTdWrap::onRspParkedOrderAction))
            .def("onRspOrderAction", pure_virtual(&SgitTdWrap::onRspOrderAction))
            .def("onRspQueryMaxOrderVolume", pure_virtual(&SgitTdWrap::onRspQueryMaxOrderVolume))
            .def("onRspSettlementInfoConfirm", pure_virtual(&SgitTdWrap::onRspSettlementInfoConfirm))
            .def("onRspRemoveParkedOrder", pure_virtual(&SgitTdWrap::onRspRemoveParkedOrder))
            .def("onRspRemoveParkedOrderAction", pure_virtual(&SgitTdWrap::onRspRemoveParkedOrderAction))
            .def("onRspExecOrderInsert", pure_virtual(&SgitTdWrap::onRspExecOrderInsert))
            .def("onRspExecOrderAction", pure_virtual(&SgitTdWrap::onRspExecOrderAction))
            .def("onRspForQuoteInsert", pure_virtual(&SgitTdWrap::onRspForQuoteInsert))
            .def("onRspQuoteInsert", pure_virtual(&SgitTdWrap::onRspQuoteInsert))
            .def("onRspQuoteAction", pure_virtual(&SgitTdWrap::onRspQuoteAction))
            .def("onRspBatchOrderAction", pure_virtual(&SgitTdWrap::onRspBatchOrderAction))
            .def("onRspCombActionInsert", pure_virtual(&SgitTdWrap::onRspCombActionInsert))
            .def("onRspQryOrder", pure_virtual(&SgitTdWrap::onRspQryOrder))
            .def("onRspQryTrade", pure_virtual(&SgitTdWrap::onRspQryTrade))
            .def("onRspQryInvestorPosition", pure_virtual(&SgitTdWrap::onRspQryInvestorPosition))
            .def("onRspQryTradingAccount", pure_virtual(&SgitTdWrap::onRspQryTradingAccount))
            .def("onRspQryInvestor", pure_virtual(&SgitTdWrap::onRspQryInvestor))
            .def("onRspQryTradingCode", pure_virtual(&SgitTdWrap::onRspQryTradingCode))
            .def("onRspQryInstrumentMarginRate", pure_virtual(&SgitTdWrap::onRspQryInstrumentMarginRate))
            .def("onRspQryInstrumentCommissionRate", pure_virtual(&SgitTdWrap::onRspQryInstrumentCommissionRate))
            .def("onRspQryExchange", pure_virtual(&SgitTdWrap::onRspQryExchange))
            .def("onRspQryProduct", pure_virtual(&SgitTdWrap::onRspQryProduct))
            .def("onRspQryInstrument", pure_virtual(&SgitTdWrap::onRspQryInstrument))
            .def("onRspQryDepthMarketData", pure_virtual(&SgitTdWrap::onRspQryDepthMarketData))
            .def("onRspQrySettlementInfo", pure_virtual(&SgitTdWrap::onRspQrySettlementInfo))
            .def("onRspQryTransferBank", pure_virtual(&SgitTdWrap::onRspQryTransferBank))
            .def("onRspQryInvestorPositionDetail", pure_virtual(&SgitTdWrap::onRspQryInvestorPositionDetail))
            .def("onRspQryNotice", pure_virtual(&SgitTdWrap::onRspQryNotice))
            .def("onRspQrySettlementInfoConfirm", pure_virtual(&SgitTdWrap::onRspQrySettlementInfoConfirm))
            .def("onRspQryInvestorPositionCombineDetail", pure_virtual(&SgitTdWrap::onRspQryInvestorPositionCombineDetail))
            .def("onRspQryCFMMCTradingAccountKey", pure_virtual(&SgitTdWrap::onRspQryCFMMCTradingAccountKey))
            .def("onRspQryEWarrantOffset", pure_virtual(&SgitTdWrap::onRspQryEWarrantOffset))
            .def("onRspQryInvestorProductGroupMargin", pure_virtual(&SgitTdWrap::onRspQryInvestorProductGroupMargin))
            .def("onRspQryExchangeMarginRate", pure_virtual(&SgitTdWrap::onRspQryExchangeMarginRate))
            .def("onRspQryExchangeMarginRateAdjust", pure_virtual(&SgitTdWrap::onRspQryExchangeMarginRateAdjust))
            .def("onRspQryExchangeRate", pure_virtual(&SgitTdWrap::onRspQryExchangeRate))
            .def("onRspQrySecAgentACIDMap", pure_virtual(&SgitTdWrap::onRspQrySecAgentACIDMap))
            .def("onRspQryProductExchRate", pure_virtual(&SgitTdWrap::onRspQryProductExchRate))
            .def("onRspQryProductGroup", pure_virtual(&SgitTdWrap::onRspQryProductGroup))
//            .def("onRspQryMMInstrumentCommissionRate", pure_virtual(&SgitTdWrap::onRspQryMMInstrumentCommissionRate))
//            .def("onRspQryMMOptionInstrCommRate", pure_virtual(&SgitTdWrap::onRspQryMMOptionInstrCommRate))
//            .def("onRspQryInstrumentOrderCommRate", pure_virtual(&SgitTdWrap::onRspQryInstrumentOrderCommRate))
            .def("onRspQryOptionInstrTradeCost", pure_virtual(&SgitTdWrap::onRspQryOptionInstrTradeCost))
            .def("onRspQryOptionInstrCommRate", pure_virtual(&SgitTdWrap::onRspQryOptionInstrCommRate))
            .def("onRspQryExecOrder", pure_virtual(&SgitTdWrap::onRspQryExecOrder))
            .def("onRspQryForQuote", pure_virtual(&SgitTdWrap::onRspQryForQuote))
            .def("onRspQryQuote", pure_virtual(&SgitTdWrap::onRspQryQuote))
            .def("onRspQryCombInstrumentGuard", pure_virtual(&SgitTdWrap::onRspQryCombInstrumentGuard))
            .def("onRspQryCombAction", pure_virtual(&SgitTdWrap::onRspQryCombAction))
            .def("onRspQryTransferSerial", pure_virtual(&SgitTdWrap::onRspQryTransferSerial))
            .def("onRspQryAccountregister", pure_virtual(&SgitTdWrap::onRspQryAccountregister))
            .def("onRspError", pure_virtual(&SgitTdWrap::onRspError))
            .def("onRtnOrder", pure_virtual(&SgitTdWrap::onRtnOrder))
            .def("onRtnTrade", pure_virtual(&SgitTdWrap::onRtnTrade))
            .def("onErrRtnOrderInsert", pure_virtual(&SgitTdWrap::onErrRtnOrderInsert))
            .def("onErrRtnOrderAction", pure_virtual(&SgitTdWrap::onErrRtnOrderAction))
            .def("onRtnInstrumentStatus", pure_virtual(&SgitTdWrap::onRtnInstrumentStatus))
//            .def("onRtnBulletin", pure_virtual(&SgitTdWrap::onRtnBulletin))
            .def("onRtnTradingNotice", pure_virtual(&SgitTdWrap::onRtnTradingNotice))
            .def("onRtnErrorConditionalOrder", pure_virtual(&SgitTdWrap::onRtnErrorConditionalOrder))
            .def("onRtnExecOrder", pure_virtual(&SgitTdWrap::onRtnExecOrder))
            .def("onErrRtnExecOrderInsert", pure_virtual(&SgitTdWrap::onErrRtnExecOrderInsert))
            .def("onErrRtnExecOrderAction", pure_virtual(&SgitTdWrap::onErrRtnExecOrderAction))
            .def("onErrRtnForQuoteInsert", pure_virtual(&SgitTdWrap::onErrRtnForQuoteInsert))
            .def("onRtnQuote", pure_virtual(&SgitTdWrap::onRtnQuote))
            .def("onErrRtnQuoteInsert", pure_virtual(&SgitTdWrap::onErrRtnQuoteInsert))
            .def("onErrRtnQuoteAction", pure_virtual(&SgitTdWrap::onErrRtnQuoteAction))
            .def("onRtnForQuoteRsp", pure_virtual(&SgitTdWrap::onRtnForQuoteRsp))
            .def("onRtnCFMMCTradingAccountToken", pure_virtual(&SgitTdWrap::onRtnCFMMCTradingAccountToken))
            .def("onErrRtnBatchOrderAction", pure_virtual(&SgitTdWrap::onErrRtnBatchOrderAction))
            .def("onRtnCombAction", pure_virtual(&SgitTdWrap::onRtnCombAction))
            .def("onErrRtnCombActionInsert", pure_virtual(&SgitTdWrap::onErrRtnCombActionInsert))
            .def("onRspQryContractBank", pure_virtual(&SgitTdWrap::onRspQryContractBank))
            .def("onRspQryParkedOrder", pure_virtual(&SgitTdWrap::onRspQryParkedOrder))
            .def("onRspQryParkedOrderAction", pure_virtual(&SgitTdWrap::onRspQryParkedOrderAction))
            .def("onRspQryTradingNotice", pure_virtual(&SgitTdWrap::onRspQryTradingNotice))
            .def("onRspQryBrokerTradingParams", pure_virtual(&SgitTdWrap::onRspQryBrokerTradingParams))
            .def("onRspQryBrokerTradingAlgos", pure_virtual(&SgitTdWrap::onRspQryBrokerTradingAlgos))
            .def("onRspQueryCFMMCTradingAccountToken", pure_virtual(&SgitTdWrap::onRspQueryCFMMCTradingAccountToken))
            .def("onRtnFromBankToFutureByBank", pure_virtual(&SgitTdWrap::onRtnFromBankToFutureByBank))
            .def("onRtnFromFutureToBankByBank", pure_virtual(&SgitTdWrap::onRtnFromFutureToBankByBank))
            .def("onRtnRepealFromBankToFutureByBank", pure_virtual(&SgitTdWrap::onRtnRepealFromBankToFutureByBank))
            .def("onRtnRepealFromFutureToBankByBank", pure_virtual(&SgitTdWrap::onRtnRepealFromFutureToBankByBank))
            .def("onRtnFromBankToFutureByFuture", pure_virtual(&SgitTdWrap::onRtnFromBankToFutureByFuture))
            .def("onRtnFromFutureToBankByFuture", pure_virtual(&SgitTdWrap::onRtnFromFutureToBankByFuture))
            .def("onRtnRepealFromBankToFutureByFutureManual", pure_virtual(&SgitTdWrap::onRtnRepealFromBankToFutureByFutureManual))
            .def("onRtnRepealFromFutureToBankByFutureManual", pure_virtual(&SgitTdWrap::onRtnRepealFromFutureToBankByFutureManual))
            .def("onRtnQueryBankBalanceByFuture", pure_virtual(&SgitTdWrap::onRtnQueryBankBalanceByFuture))
            .def("onErrRtnBankToFutureByFuture", pure_virtual(&SgitTdWrap::onErrRtnBankToFutureByFuture))
            .def("onErrRtnFutureToBankByFuture", pure_virtual(&SgitTdWrap::onErrRtnFutureToBankByFuture))
            .def("onErrRtnRepealBankToFutureByFutureManual", pure_virtual(&SgitTdWrap::onErrRtnRepealBankToFutureByFutureManual))
            .def("onErrRtnRepealFutureToBankByFutureManual", pure_virtual(&SgitTdWrap::onErrRtnRepealFutureToBankByFutureManual))
            .def("onErrRtnQueryBankBalanceByFuture", pure_virtual(&SgitTdWrap::onErrRtnQueryBankBalanceByFuture))
            .def("onRtnRepealFromBankToFutureByFuture", pure_virtual(&SgitTdWrap::onRtnRepealFromBankToFutureByFuture))
            .def("onRtnRepealFromFutureToBankByFuture", pure_virtual(&SgitTdWrap::onRtnRepealFromFutureToBankByFuture))
            .def("onRspFromBankToFutureByFuture", pure_virtual(&SgitTdWrap::onRspFromBankToFutureByFuture))
            .def("onRspFromFutureToBankByFuture", pure_virtual(&SgitTdWrap::onRspFromFutureToBankByFuture))
            .def("onRspQueryBankAccountMoneyByFuture", pure_virtual(&SgitTdWrap::onRspQueryBankAccountMoneyByFuture))
            .def("onRtnOpenAccountByBank", pure_virtual(&SgitTdWrap::onRtnOpenAccountByBank))
            .def("onRtnCancelAccountByBank", pure_virtual(&SgitTdWrap::onRtnCancelAccountByBank))
            .def("onRtnChangeAccountByBank", pure_virtual(&SgitTdWrap::onRtnChangeAccountByBank))
            .def("getApiVersion", &SgitTdWrap::getApiVersion)
            .def("release", &SgitTdWrap::release)
            .def("init", &SgitTdWrap::init)
            .def("join", &SgitTdWrap::join)
            .def("getTradingDay", &SgitTdWrap::getTradingDay)
            .def("registerFront", &SgitTdWrap::registerFront)
            .def("registerNameServer", &SgitTdWrap::registerNameServer)
            .def("registerFensUserInfo", &SgitTdWrap::registerFensUserInfo)
            .def("registerSpi", &SgitTdWrap::registerSpi)
            .def("subscribePrivateTopic", &SgitTdWrap::subscribePrivateTopic)
            .def("subscribePublicTopic", &SgitTdWrap::subscribePublicTopic)
            .def("reqAuthenticate", &SgitTdWrap::reqAuthenticate)
            .def("reqUserLogin", &SgitTdWrap::reqUserLogin)
            .def("reqUserLogout", &SgitTdWrap::reqUserLogout)
            .def("reqUserPasswordUpdate", &SgitTdWrap::reqUserPasswordUpdate)
            .def("reqTradingAccountPasswordUpdate", &SgitTdWrap::reqTradingAccountPasswordUpdate)
            .def("reqOrderInsert", &SgitTdWrap::reqOrderInsert)
            .def("reqParkedOrderInsert", &SgitTdWrap::reqParkedOrderInsert)
            .def("reqParkedOrderAction", &SgitTdWrap::reqParkedOrderAction)
            .def("reqOrderAction", &SgitTdWrap::reqOrderAction)
            .def("reqQueryMaxOrderVolume", &SgitTdWrap::reqQueryMaxOrderVolume)
            .def("reqSettlementInfoConfirm", &SgitTdWrap::reqSettlementInfoConfirm)
            .def("reqRemoveParkedOrder", &SgitTdWrap::reqRemoveParkedOrder)
            .def("reqRemoveParkedOrderAction", &SgitTdWrap::reqRemoveParkedOrderAction)
            .def("reqExecOrderInsert", &SgitTdWrap::reqExecOrderInsert)
            .def("reqExecOrderAction", &SgitTdWrap::reqExecOrderAction)
            .def("reqForQuoteInsert", &SgitTdWrap::reqForQuoteInsert)
            .def("reqQuoteInsert", &SgitTdWrap::reqQuoteInsert)
            .def("reqQuoteAction", &SgitTdWrap::reqQuoteAction)
            .def("reqBatchOrderAction", &SgitTdWrap::reqBatchOrderAction)
            .def("reqCombActionInsert", &SgitTdWrap::reqCombActionInsert)
            .def("reqQryOrder", &SgitTdWrap::reqQryOrder)
            .def("reqQryTrade", &SgitTdWrap::reqQryTrade)
            .def("reqQryInvestorPosition", &SgitTdWrap::reqQryInvestorPosition)
            .def("reqQryTradingAccount", &SgitTdWrap::reqQryTradingAccount)
            .def("reqQryInvestor", &SgitTdWrap::reqQryInvestor)
            .def("reqQryTradingCode", &SgitTdWrap::reqQryTradingCode)
            .def("reqQryInstrumentMarginRate", &SgitTdWrap::reqQryInstrumentMarginRate)
            .def("reqQryInstrumentCommissionRate", &SgitTdWrap::reqQryInstrumentCommissionRate)
            .def("reqQryExchange", &SgitTdWrap::reqQryExchange)
            .def("reqQryProduct", &SgitTdWrap::reqQryProduct)
            .def("reqQryInstrument", &SgitTdWrap::reqQryInstrument)
            .def("reqQryDepthMarketData", &SgitTdWrap::reqQryDepthMarketData)
            .def("reqQrySettlementInfo", &SgitTdWrap::reqQrySettlementInfo)
            .def("reqQryTransferBank", &SgitTdWrap::reqQryTransferBank)
            .def("reqQryInvestorPositionDetail", &SgitTdWrap::reqQryInvestorPositionDetail)
            .def("reqQryNotice", &SgitTdWrap::reqQryNotice)
            .def("reqQrySettlementInfoConfirm", &SgitTdWrap::reqQrySettlementInfoConfirm)
            .def("reqQryInvestorPositionCombineDetail", &SgitTdWrap::reqQryInvestorPositionCombineDetail)
            .def("reqQryCFMMCTradingAccountKey", &SgitTdWrap::reqQryCFMMCTradingAccountKey)
            .def("reqQryEWarrantOffset", &SgitTdWrap::reqQryEWarrantOffset)
            .def("reqQryInvestorProductGroupMargin", &SgitTdWrap::reqQryInvestorProductGroupMargin)
            .def("reqQryExchangeMarginRate", &SgitTdWrap::reqQryExchangeMarginRate)
            .def("reqQryExchangeMarginRateAdjust", &SgitTdWrap::reqQryExchangeMarginRateAdjust)
            .def("reqQryExchangeRate", &SgitTdWrap::reqQryExchangeRate)
            .def("reqQrySecAgentACIDMap", &SgitTdWrap::reqQrySecAgentACIDMap)
            .def("reqQryProductExchRate", &SgitTdWrap::reqQryProductExchRate)
            .def("reqQryProductGroup", &SgitTdWrap::reqQryProductGroup)
//            .def("reqQryMMInstrumentCommissionRate", &SgitTdWrap::reqQryMMInstrumentCommissionRate)
//            .def("reqQryMMOptionInstrCommRate", &SgitTdWrap::reqQryMMOptionInstrCommRate)
//            .def("reqQryInstrumentOrderCommRate", &SgitTdWrap::reqQryInstrumentOrderCommRate)
            .def("reqQryOptionInstrTradeCost", &SgitTdWrap::reqQryOptionInstrTradeCost)
            .def("reqQryOptionInstrCommRate", &SgitTdWrap::reqQryOptionInstrCommRate)
            .def("reqQryExecOrder", &SgitTdWrap::reqQryExecOrder)
            .def("reqQryForQuote", &SgitTdWrap::reqQryForQuote)
            .def("reqQryQuote", &SgitTdWrap::reqQryQuote)
            .def("reqQryCombInstrumentGuard", &SgitTdWrap::reqQryCombInstrumentGuard)
            .def("reqQryCombAction", &SgitTdWrap::reqQryCombAction)
            .def("reqQryTransferSerial", &SgitTdWrap::reqQryTransferSerial)
            .def("reqQryAccountregister", &SgitTdWrap::reqQryAccountregister)
            .def("reqQryContractBank", &SgitTdWrap::reqQryContractBank)
            .def("reqQryParkedOrder", &SgitTdWrap::reqQryParkedOrder)
            .def("reqQryParkedOrderAction", &SgitTdWrap::reqQryParkedOrderAction)
            .def("reqQryTradingNotice", &SgitTdWrap::reqQryTradingNotice)
            .def("reqQryBrokerTradingParams", &SgitTdWrap::reqQryBrokerTradingParams)
            .def("reqQryBrokerTradingAlgos", &SgitTdWrap::reqQryBrokerTradingAlgos)
            .def("reqQueryCFMMCTradingAccountToken", &SgitTdWrap::reqQueryCFMMCTradingAccountToken)
            .def("reqFromBankToFutureByFuture", &SgitTdWrap::reqFromBankToFutureByFuture)
            .def("reqFromFutureToBankByFuture", &SgitTdWrap::reqFromFutureToBankByFuture)
            .def("reqQueryBankAccountMoneyByFuture", &SgitTdWrap::reqQueryBankAccountMoneyByFuture);
